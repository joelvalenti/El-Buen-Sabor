...
import { CategoriaInsumoService } from '../../../services/administrador/categoriaInsumo.service'
import Swal from'sweetalert2';
import { InsumoService } from 'src/app/services/administrador/insumo.service';
@Component({
  selector: 'app-insumo',
