...
import { PedidoService } from '../../../services/administrador/pedido.service';
import { DetalleService } from '../../../services/administrador/detalle.service';
...
export class PedidoComponent implements OnInit {
  ...
  public displayedColumns: string[] = ['numero', 'detallePedido','fecha','horaEstimada', 'envioDelivery', 'domicilio', 'monto', 'estado'];
