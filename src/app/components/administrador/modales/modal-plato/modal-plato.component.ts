...
import { PlatoService } from './../../../../services/administrador/plato.service';
...
import { DetallePlatoService } from 'src/app/services/administrador/detalleplato.service';
...
export class ModalPlatoComponent implements OnInit {
  ...
  buildForm() {
    this.form = this.formBuilder.group({
      ...
      precioVenta:[this.localData.precioVenta],
